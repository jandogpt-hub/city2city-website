...
$city_slug = 'rowland-heights';
$city_state = 'CA';

// Page-specific SEO
$page_title = 'Forklift Repair in ' . $city_name . ', ' . $city_state . ' | ' . BUSINESS_NAME;
$page_description = 'Mobile forklift repair services in ' . $city_name . '. On-site forklift repair in Rowland Heights. Call ' . BUSINESS_PHONE;
