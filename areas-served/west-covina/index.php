...
$city_slug = 'west-covina';
$city_state = 'CA';

// Page-specific SEO
$page_title = 'Forklift Repair in ' . $city_name . ', ' . $city_state . ' | ' . BUSINESS_NAME;
$page_description = 'Mobile forklift repair services in ' . $city_name . '. Mobile forklift repair throughout West Covina. Call ' . BUSINESS_PHONE;
