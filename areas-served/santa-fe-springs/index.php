...
$city_slug = 'santa-fe-springs';
$city_state = 'CA';

// Page-specific SEO
$page_title = 'Forklift Repair in ' . $city_name . ', ' . $city_state . ' | ' . BUSINESS_NAME;
$page_description = 'Mobile forklift repair services in ' . $city_name . '. Serving industrial facilities in Santa Fe Springs. Call ' . BUSINESS_PHONE;
