...
<section class="hero">
    <div class="container">
        <div class="hero-content">
            ...
            <h1 class="hero-title">
                Need Mobile Forklift Repair Service near City of Industry?<br>
                <span>We're On Our Way.</span>
            </h1>

            <p class="hero-description">
                City 2 City Industrial Repair is a premier forklift repair company that shows up when we say and fixes
                it right the first time. Serving City of Industry and surrounding areas with honest, warranty-backed
                service.
            </p>
...
<section class="section" id="services">
    <div class="container">
        <header class="section-header">
            ...
            <p class="section-subtitle">From emergency breakdowns to preventative maintenance, we keep your forklifts
                running.</p>
        </header>
    ...
    <div class="container">
        <div class="why-grid">
            ...
            <div class="why-content">
                ...
                <h2 class="section-title" style="text-align: left; margin-bottom: var(--space-6);">The Forklift Repair
                    Service You Can Actually Count On</h2>
                <p style="margin-bottom: var(--space-8); color: var(--color-foreground-muted);">
                    We started City 2 City because the industry needed a repair service that shows up on time and stands
                    behind their work. That's exactly what we deliver.
                </p>
                ...
                <div class="why-item">
                    ...
                    <div class="why-item-content">
                        ...
                        <p>No need to transport your equipment. Our fully-equipped mobile shop comes to your facility.
                        </p>
                    </div>
                </div>
            </div>
...
<section class="section" id="areas">
    <div class="container">
        <header class="section-header">
            ...
            <p class="section-subtitle">Mobile forklift repair throughout City of Industry and surrounding communities.
            </p>
        </header>
    ...
    <div class="container">
        ...
        <div class="reviews-grid">
            <article class="review-card">
                ...
                <p class="review-text">"Our forklift started leaking, so based on the great reviews, I called City 2
                    City and spoke with Jesse. He was quick to respond and got us back up and running the same day."</p>
            ...
            <article class="review-card">
                ...
                <p class="review-text">"He was quick to do the job and was a better price than others I researched. He
                    fixed it in less than an hour. Highly recommend City 2 City."</p>
            ...
            <article class="review-card">
                ...
                <p class="review-text">"If I could give 10 stars, I would. Jesse cares about his customers and about his
                    work. Our scissor lift repair was done perfectly."</p>
